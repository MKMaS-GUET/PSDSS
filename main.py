...
if __name__ == '__main__':
    ...
    # parser.add_argument('--phase', type=str, default="train", help="genload, gendata, train, test, update or clean")
    # parser.add_argument('--table', type=str, default="single", help="multi or single")
    # parser.add_argument("--dataset", type=str, default="census", help="the dir name of csv files")
    ...
    parser.add_argument('--table', type=str, default="single", help="multi or single")
    parser.add_argument("--dataset", type=str, default="forest", help="the dir name of csv files")
    parser.add_argument("--workload", type=str, default="generate", help="the dir name of sql file")
    parser.add_argument("--model", type=str, default="nn", help="nn or gdbt")
    parser.add_argument("--testW", type=str, default="test", help="the dir name of sql file")

    # parser.add_argument('--phase', type=str, default="test", help="genload, gendata, train, test, update or clean")
    # parser.add_argument('--table', type=str, default="single", help="multi or single")
    # parser.add_argument("--dataset", type=str, default="census", help="the dir name of csv files")
    # parser.add_argument("--workload", type=str, default="generate", help="the dir name of sql file")
    # parser.add_argument("--model", type=str, default="nn", help="nn or gdbt")
    ...
    # parser.add_argument('--phase', type=str, default="gendata", help="genload, gendata, train, test, update or clean")
    # parser.add_argument('--table', type=str, default="multi", help="multi or single")
    # parser.add_argument("--dataset", type=str, default="job-light", help="the dir name of csv files")
    # parser.add_argument("--workload", type=str, default="synthetic", help="the dir name of sql file")
    # parser.add_argument("--model", type=str, default="nn", help="nn or gdbt")
    # parser.add_argument("--testW", type=str, default="test", help="the dir name of sql file")
    ...
    # parser.add_argument('--table', type=str, default="multi", help="multi or single")
    # parser.add_argument("--dataset", type=str, default="job-light", help="the dir name of csv files")
    # parser.add_argument("--workload", type=str, default="job-light", help="the dir name of sql file") 
    # parser.add_argument("--model", type=str, default="nn", help="nn or gdbt")
    # parser.add_argument("--testW", type=str, default="test", help="the dir name of sql file")
    ...
    # parser.add_argument('--table', type=str, default="multi", help="multi or single")
    # parser.add_argument("--dataset", type=str, default="job-light", help="the dir name of csv files")
    # parser.add_argument("--workload", type=str, default="train", help="the dir name of sql file")
    # parser.add_argument("--model", type=str, default="nn", help="nn or gdbt")
    # parser.add_argument("--testW", type=str, default="job-light", help="the dir name of sql file")
    ...
    if arguments.phase == "genload":
        ...
        if arguments.table == "single" and arguments.workload == "generate":
            ...
            valid_path = C.DATASET_PATH / f"{arguments.dataset}-job-light.pkl"
